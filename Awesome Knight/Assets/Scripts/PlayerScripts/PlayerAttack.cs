    ...
    void CheckInput()
    {
        if(anim.GetInteger("Atk")==0)
        {
            ...
            if(Input.GetKeyDown(KeyCode.Alpha1))
            {
                ...
                if(playerMove.FinishedMovement && canAttack && fadeImages[0] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[0] = 1;
           ...
           else if (Input.GetKeyDown(KeyCode.Alpha2))
            {
                ...
                if (playerMove.FinishedMovement && canAttack && fadeImages[1] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[1] = 1;
          ...
          else  if (Input.GetKeyDown(KeyCode.Alpha3))
            {
                ...
                if (playerMove.FinishedMovement && canAttack && fadeImages[2] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[2] = 1;
           ...
           else if (Input.GetKeyDown(KeyCode.Alpha4))
            {
                ...
                if (playerMove.FinishedMovement && canAttack && fadeImages[3] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[3] = 1;
           ...
           else if (Input.GetKeyDown(KeyCode.Alpha5))
            {
                ...
                if (playerMove.FinishedMovement && canAttack && fadeImages[4] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[4] = 1;
          ...
          else  if (Input.GetMouseButtonDown(1))
            {
                ...
                if (playerMove.FinishedMovement && canAttack && fadeImages[5] != 1) //fadeImages[0] means image that at index
                {
                    fadeImages[5] = 1;
